...
#include <vector>
#include <string>
const std::vector me_baier_AES_byte2hex__B_Ljava_lang_String_ = {
...
const std::vector me_baier_AES_Encrypt_Ljava_lang_String_Ljava_lang_String__Ljava_lang_String_ = {
...
const std::vector me_baier_AES_hex2byte_Ljava_lang_String___B = {
...
const std::vector me_baier_AES_Decrypt_Ljava_lang_String_Ljava_lang_String__Ljava_lang_String_ = {
        static_cast<uint8_t>(0x2B),// 0
        static_cast<uint8_t>(0xC7),// 1
        static_cast<uint8_t>(0x00),// 2
        static_cast<uint8_t>(0x0D),// 3
...
{
    inject("me/baier/AES","byte2hex([B)Ljava/lang/String;",me_baier_AES_byte2hex__B_Ljava_lang_String_);
    inject("me/baier/AES","Encrypt(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;",me_baier_AES_Encrypt_Ljava_lang_String_Ljava_lang_String__Ljava_lang_String_);
    inject("me/baier/AES","hex2byte(Ljava/lang/String;)[B",me_baier_AES_hex2byte_Ljava_lang_String___B);
    inject("me/baier/AES","Decrypt(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;",me_baier_AES_Decrypt_Ljava_lang_String_Ljava_lang_String__Ljava_lang_String_);
}
#endif //CLASSES_H